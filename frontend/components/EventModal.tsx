...
import { X, Calendar, MapPin, Users, Clock, Share2, Heart, MessageSquare } from 'lucide-react';
...
const EventModal: React.FC<EventModalProps> = ({ event, isOpen, onClose, onRegister, isRegistered }) => {
      ...
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl w-full">
          ...
          <div className="px-6 py-6">
            ...
            <p className="text-sm text-gray-500 mb-6">Hosted by <span className="font-semibold text-indigo-600">College ID: {event.collegeId}</span></p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-start">
                         ...
                         <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">{new Date(event.endDate).toLocaleString()}</p>
                            </div>
                        </div>
                        <div className="flex items-start">
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">{event.participantsCount} / {event.maxParticipants}</p>
                            </div>
                        </div>
                    </div>
          ...
          <div className="bg-gray-50 px-6 py-4 flex items-center justify-between border-t border-gray-100">
             ...
             <button 
                onClick={onRegister}
                disabled={isRegistered || event.participantsCount >= event.maxParticipants}
             ...
             >
                {isRegistered ? 'Registered' : event.participantsCount >= event.maxParticipants ? 'Full' : 'Register Now'}
             </button>
          </div>
        </div>
      </div>
