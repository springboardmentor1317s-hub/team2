...
const EventForm: React.FC<EventFormProps> = ({ onClose, onSubmit, currentUserCollegeId }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const finalImageUrl = previewUrl || CATEGORY_IMAGES[formData.category as keyof typeof CATEGORY_IMAGES];
              ...
              >               
                ...
                <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  <p className="text-white text-sm font-medium">
                    {previewUrl ? "Change Custom Image" : "Upload Custom Banner"}
                  </p>
                  <p className="text-white text-xs opacity-75 mt-1">Currently showing category default</p>
                </div>
            ...
            <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <select
                    id="category"
                    name="category"
                    className="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-lg p-2.5 border bg-white text-gray-900"
              ...
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  id="maxParticipants"
                  className="focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-lg p-2.5 border mt-1 text-gray-900"
                  placeholder="e.g. 200"
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  name="description"
                  rows={3}
                  className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-300 rounded-lg p-2.5 mt-1 text-gray-900"
