  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-24 right-6 z-50 bg-indigo-600 hover:bg-indigo-700 text-white p-3.5 rounded-full shadow-lg transition-all hover:scale-110 flex items-center justify-center group"
      >
